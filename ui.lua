...
function library:CreateSettingsTab(menu)
    ...
    local creditsSection = settingsTab:AddSection('Binsploit Credits', 2);
    creditsSection:AddSeparator({text = 'Developers'});
    creditsSection:AddText({text = "binwonk"})
    local creditsSection = settingsTab:AddSection('UI Credits', 2);
